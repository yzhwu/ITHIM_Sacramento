...
For more information about the project background, analysis methods and results, and model source code and data, please refer to [ITHIM-Sacramento GitHub](https://github.com/aakarner)
...
**1. How can I view the estimated health impacts of the regional transportation plan?**
...
**2. What is shown in the Simple Aggregated Plot tab?**
...
A: The Simple Aggregated Plots tab shows estimated health impacts due to physical activity and injury effects for the entire population of the Sacramento region (including all six SACOG counties). You can tailor the outputs by scenario and units shown:
  ...
  * Scenario:
    + Future Years: This shows the preferred scenario outcomes modeled in three future years.  Results are shown relative to the 2012 baseline.
    + Scenarios: This shows three alternative scenario outcomes modeled in 2036. Scenario 2 is the preferred scenario. Results are shown relative to the 2012 baseline.
  * Units shown:
    ...
    +	Normalized values are age-standardized per capita results; these allow for a comparison of risks experienced by individuals of different race/ethnicity or income or living in different geographic areas.
    +	Physical Activity Data show minutes per week per capita walking or biking.

**3. What is shown in the Advanced Plots tab?**
...
A: The Advanced Plots tab shows estimated health impacts for several subpopulations in the region (broken out by race/ethnicity, income, county) and also allows the user to view health impacts by physical activity, injury, or both. You can tailor the outputs by the geographic area, scenario, demographic group, outcome, and units shown:
  ...
  * Scenario:
    + Future year: This shows the preferred scenario outcomes modeled in three future years.  Results are shown relative to the 2012 baseline.
    + Scenarios: This shows three alternative scenario outcomes modeled in 2036. Scenario 2 is the preferred scenario. Results are shown relative to the 2012 baseline.
  * Demographic Group:
    1. Race/Ethnicity:
      ...
      - For “traffic injury” and “both” outcomes this includes two categories. “White” is non-Hispanic White, “Other” is all other races (Hispanic and non-Hispanic) plus Hispanic White.
    2. Income:
...
**4. What scenarios and years are shown?**  

A: Outputs shown are estimates of health effects of the SACOG 2016 MTP/SCS. The Simple and Advanced tabs both allow you to specify two types of scenario outputs form the: scenarios and years.  Selecting “scenarios” shows XX S1, S2, S3 (?describe) in year XX (relative to the 2012 baseline).  Selecting “Future Years” shows the preferred scenario in years 2020, 2027, and 2036 (relative to the 2012 baseline).

**5. What are the health risk values shown?**

A: The health risk reductions shown on the y-axis are presented as relative to the preferred scenario in the baseline year of 2012. Deaths indicate expected mortality. DALYs indicate expected disability adjusted life-years, which is a measure of disease burden. Total values indicate the total impact to a population or geographic area. Normalized values are age-standardized per capita results; these allow for a comparison of risks faced by individuals of different race/ethnicity or income or living in different geographic areas. Physical Activity Data show minutes per week per capita walking or biking.
